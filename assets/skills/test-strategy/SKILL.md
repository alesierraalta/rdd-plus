...
This skill is written for `rdd-plus 0.3.15`, and `rdd-plus version` prints the build present.
...
applying its checks by hand, as aligned with test-strategy 0.3.18 — the Findings section exists and is a
